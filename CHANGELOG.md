...
### Added
- `orchesis verify`: 15 pre-flight checks (policy startup validation, ports, Python env, MCP discovery, upstream HEAD, disk space, and existing checks)
...
### Tests
- 4,912+ passing (up from 4,377 at start of sprint)
