...
def test_tool_policy_fallthrough() -> None:
    ...
    tpe = ToolPolicyEngine(
        {"default_action": "allow", "rules": {"read_file": "allow"}}, policy_engine=pe
    )
