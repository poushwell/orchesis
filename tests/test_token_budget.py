...
def test_per_call_limit_allows_under() -> None:
    request = {
        ...
        "params": {},
        "cost": 0.0,
        "context": {"estimated_tokens": 1000, "agent": "tb_under"},
    }
...
def test_per_call_limit_denies_over() -> None:
    request = {
        ...
        "params": {},
        "cost": 0.0,
        "context": {"estimated_tokens": 5000, "agent": "tb_over"},
    }
    decision = evaluate(request, _policy(), now=datetime(2026, 1, 1, tzinfo=timezone.utc))
...
def test_per_session_limit_denies_over() -> None:
    request = {
        ...
        "context": {
            ...
            "session_tokens_used": 49000,
            "agent": "tb_sess_denied",
        },
    }
    decision = evaluate(request, _policy(), now=datetime(2026, 1, 1, tzinfo=timezone.utc))
    assert decision.allowed is False
...
def test_per_day_limit_allows_under() -> None:
    request = {
        ...
        "params": {},
        "cost": 0.0,
        "context": {"estimated_tokens": 3000, "agent": "tb_day_ok"},
    }
...
def test_per_day_limit_denies_over() -> None:
    request = {
        ...
        "params": {},
        "cost": 0.0,
        "context": {"estimated_tokens": 4000, "agent": "tb_day_over"},
    }
    for _ in range(125):
        assert (
            evaluate(request, _policy(), now=datetime(2026, 1, 3, tzinfo=timezone.utc)).allowed
            is True
        )
...
def test_daily_usage_accumulates() -> None:
    ...
    request = {
        ...
        "params": {},
        "cost": 0.0,
        "context": {"estimated_tokens": 1000, "agent": "tb_acc"},
    }
    for _ in range(5):
        assert (
            evaluate(request, policy, now=datetime(2026, 1, 4, tzinfo=timezone.utc)).allowed is True
        )
...
def test_session_override_per_call() -> None:
    ...
    request = {
        ...
        "params": {},
        "cost": 0.0,
        "context": {"estimated_tokens": 1200, "agent": "tb_bg"},
    }
    decision = evaluate(
        request, policy, session_type="background", now=datetime(2026, 1, 5, tzinfo=timezone.utc)
    )
    assert decision.allowed is False
...
def test_no_token_info_skips_check() -> None:
    decision = evaluate(
        {"tool": "read_file", "params": {}, "cost": 0.0, "context": {"agent": "tb_skip"}},
        _policy(),
    ...
    decision = evaluate(
        {
            ...
            "params": {},
            "cost": 0.0,
            "context": {"estimated_tokens": 999999, "agent": "tb_none"},
        },
        {"rules": []},
