...
def test_simulation_returns_result() -> None:
    ...
    out = analyzer.simulate(
        {"budgets": {"daily": 5}}, {"budgets": {"daily": 3}}, _sample_requests()
    )
...
def test_changes_detected() -> None:
    analyzer = PolicyImpactAnalyzer()
    out = analyzer.simulate(
        {"budgets": {"daily": 5}}, {"budgets": {"daily": 4}}, _sample_requests()
    )
...
def test_impact_rate_computed() -> None:
    analyzer = PolicyImpactAnalyzer()
    out = analyzer.simulate(
        {"budgets": {"daily": 5}}, {"budgets": {"daily": 2}}, _sample_requests()
    )
...
def test_safe_to_apply_flag() -> None:
    analyzer = PolicyImpactAnalyzer()
    safe = analyzer.simulate(
        {"budgets": {"daily": 5}}, {"budgets": {"daily": 4.9}}, _sample_requests()
    )
    unsafe = analyzer.simulate(
        {"budgets": {"daily": 9}}, {"budgets": {"daily": 1}}, _sample_requests()
    )
...
def test_new_blocks_counted() -> None:
    analyzer = PolicyImpactAnalyzer()
    out = analyzer.simulate(
        {"budgets": {"daily": 9}}, {"budgets": {"daily": 2}}, _sample_requests()
    )
...
def test_new_allows_counted() -> None:
    analyzer = PolicyImpactAnalyzer()
    out = analyzer.simulate(
        {"budgets": {"daily": 2}}, {"budgets": {"daily": 9}}, _sample_requests()
    )
