"""Run adversarial attacks against CrewAI agent WITH Orchesis."""
...
def run_attack(agent: CrewAIStressAgent, guard: OrchesisToolGuard, attack_name: str, prompt_file: str) -> dict:
...
def main() -> None:
    ...
    output_path = output_dir / "crewai_with_orchesis.json"
