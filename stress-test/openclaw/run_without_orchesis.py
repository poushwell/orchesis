"""Run adversarial attacks against simulated OpenClaw agent WITHOUT Orchesis protection."""
...
def run_attack(agent, attack_name: str, prompt_file: str):
...
def main():
    ...
    results.append(run_attack(agent, "prompt_injection", "prompt_injection.txt"))
    results.append(run_attack(agent, "secret_exfiltration", "exfiltration_prompt.txt"))
    results.append(run_attack(agent, "path_traversal", "path_traversal_prompt.txt"))

    output_dir = ROOT / "results"
    output_dir.mkdir(parents=True, exist_ok=True)
    output_path = output_dir / "openclaw_without_orchesis.json"
