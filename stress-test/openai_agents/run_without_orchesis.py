"""Run adversarial attacks against OpenAI Agents SDK wrapper WITHOUT Orchesis."""
...
def run_attack(agent: OpenAIAgentsStressAgent, attack_name: str, prompt_file: str) -> dict:
...
def main() -> None:
    ...
    output_path = output_dir / "openai_agents_without_orchesis.json"
