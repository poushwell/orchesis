"""Run adversarial attacks against LangGraph agent WITHOUT Orchesis."""
...
def run_attack(agent: LangGraphStressAgent, attack_name: str, prompt_file: str) -> dict:
...
def main() -> None:
    ...
    output_path = output_dir / "langgraph_without_orchesis.json"
