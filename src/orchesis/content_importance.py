"""Content Importance — compressibility-based importance scoring.

Importance heuristic from compressibility + correlation.
...
class ContentImportance:
    """Approximate content complexity via compression."""
    ...
    def compute_importance(self, message: dict) -> dict[str, Any]:
        """Compute compressibility-based importance score."""
