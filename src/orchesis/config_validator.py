...
class ConfigValidator:
    ...
    def validate(self, policy: dict[str, Any]) -> dict[str, Any]:
        ...
        if (
            ...
            and "daily" in budgets
            and not isinstance(budgets["daily"], (int, float))
        ):
    ...
    def suggest_additions(self, policy: dict[str, Any]) -> list[str]:
        ...
        if "content_ranker" not in policy:
            suggestions.append("Add content_ranker: {enabled: true} for pipeline component")
