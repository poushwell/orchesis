...
class PaperGenerator:
    """Full research paper package generator.
    ...
    NOVELTY_CLAIMS = [
        ...
        "Proxy as context management layer — empirical advantage",
    ...
    def generate_abstract(self) -> str:
        ...
        return (
            "Network-Level Context Pipeline defines context management as a network-layer "
            ...
            "separability in controlled settings. We present the pipeline as a reproducible systems framework for fleet-level "
    ...
    def generate_introduction(self) -> str:
        ...
        return (
            ...
            "the pipeline introduces a formal network-level abstraction where a proxy enforces shared context governance, "
            "resource controls, and observability. This paper provides the definition, rationale, and experimental "
            "evidence supporting the pipeline as a practical architecture for production agents."
        )
    ...
    def generate_novelty_section(self) -> str:
        ...
        header = "the pipeline novelty claims against prior context tooling:\n"
    ...
    def generate_full_paper(self) -> dict:
        ...
        return {
            ...
            "conclusion": (
                "the pipeline provides a deployable network abstraction for context quality, cost control, and safety, "
