...
class PipelineDebugger:
    ...
    def _evaluate_with_policy(
        self, request: dict[str, Any], policy: dict[str, Any] | None = None
    ) -> tuple[str, str | None]:
        ...
        blocked_keywords = effective_policy.get(
            "blocked_keywords", ["malware", "exfiltrate", "drop table"]
        )
        ...
        if (
            ...
            and tool
            and tool not in {str(item) for item in allowed_tools}
        ):
