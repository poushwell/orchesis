"""Budget allocator using second-price auction strategy."""
...
class BudgetAllocator:
    ...
    Second-price auction — agents bid for context budget.
    Incentive-compatible: truthful bidding is dominant strategy.
    Pipeline component — fleet budget coordination.
    """
    ...
    def run_auction(self) -> dict:
        """Run the auction. Returns allocations."""
        with self._lock:
