"""Context Quality Index - unified quality score computation.
...
class ContextQualityIndex:
    ...
    def compute_quality_score(self, metrics: dict) -> dict:
        """Compute unified quality score from component metrics."""
