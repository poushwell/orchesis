...
class OpenTelemetryBridge:
    ...
    METRIC_NAMES = {
        ...
        "token_yield": "orchesis.pipeline.token_yield",
        "context_quality": "orchesis.pipeline.context_quality",
    }
            ...
            "resourceMetrics": [
                {
                    ...
                    "scopeMetrics": [
                        {"scope": {"name": "orchesis.otel_bridge"}, "metrics": metrics}
                    ],
                }
            ]
        }
    ...
    def generate_trace(self, request: dict, decision: dict) -> dict:
        ...
        attrs = [
            ...
            {
                "key": "orchesis.decision.final",
                "value": {
                    "stringValue": str(dec.get("decision", dec.get("final_decision", "UNKNOWN")))
                },
            },
        ]
        return {
