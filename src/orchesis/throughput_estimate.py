"""Throughput estimate based on signal-to-noise model.

C_eff = B_eff x I(context; response | task)

Effective channel capacity for context -> response information transfer.
Throughput-estimate generalization beyond uniform-noise assumption.

Special case: uniform token distribution + additive white noise.
...
class ShannonHartleyCalculator:
    """Context throughput estimate based on signal-to-noise."""
