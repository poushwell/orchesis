...
Adaptive gain scheduling per agent.
...
class AdaptiveController:
    ...
    def update(self, agent_id: str, actual_quality: float) -> dict:
        ...
        with self._lock:
            ...
            quality_score = float(actual_quality)
            error = quality_score - ref
    ...
    def get_gains(self, agent_id: str) -> dict:
        ...
        with self._lock:
            ...
            return {
                key: value for key, value in self._agents[aid].items() if key.startswith("gain_")
            }
