...
class SystemHealthReport:
    ...
    def _check_security(self, state: Any) -> dict[str, Any]:
        return {
            ...
            "adversarial_tracker": hasattr(state, "adversarial_tracker"),
            "threat_history": hasattr(state, "threat_history"),
        }
    ...
    def _check_fleet(self, state: Any) -> dict[str, Any]:
        return {
            "status": "ready",
            "fleet_consensus": hasattr(state, "quorum_sensor"),
            "byzantine_detector": hasattr(state, "byzantine_detector"),
            "context_sync": hasattr(state, "context_sync"),
        }
