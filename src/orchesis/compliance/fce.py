...
RULE_ART9_TRANSPARENCY = ComplianceRule(
    ...
    article="Article 9",
    description=(
        "Risk management shall include identification and analysis of known and foreseeable risks."
    ),
    severity="MEDIUM",
)
...
class FleetComplianceEngine:
    ...
    def __init__(
        self, policy: dict[str, Any] | None = None, fleet_state: dict[str, Any] | None = None
    ):
